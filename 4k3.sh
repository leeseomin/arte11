...
cd ..
cd s
parallel gmic {} -fx_imagegrid 30,30 -o ../s2/{} ::: *.*
cd ..
cd s2
...
for i in *.* 
do 
convert $i ../s18/$i -alpha set  -compose softlight -composite ../s3/$i 
done 
cd ..
cd s3
...
for i in *.* 
do 
convert $i ../s3/$i -alpha set  -compose softlight -composite ../s22/$i 
done 
cd ..
cd s22
...
for i in *.* 
do 
convert $i ../s3/$i -alpha set  -compose softlight -composite ../s23/$i 
done 
cd ..
cd s23
...
for i in *.* 
do 
convert $i ../s/$i -alpha set  -compose softlight -composite ../s24/$i 
done 
cd ..
cd s24
parallel convert {}  -set filename:new  ../s25/"%tc5" "%[filename:new].png" ::: *.*
